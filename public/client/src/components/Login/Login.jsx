      ...
      <div className='wrapper'>
        ...
        <form className='login-contents' onSubmit={__doLogin}>
          <div className='email-inp custom-inp'>
            ...
            <div className='inp'>
              <input type='email' placeholder='이메일을 입력해주세요' onBlur={(e) => setEmail(e.target.value)} required />
            </div>
          </div>
          <div className='password-inp custom-inp'>
            <div className='title txt-bold'>비밀번호</div>
            <div className='inp'>
              <input type='password' placeholder='비밀번호를 입력해주세요' onBlur={(e) => setPassword(e.target.value)} required />
            </div>
          </div>
        ...
        <div className='go-join' onClick={__goJoin}>
          ...
          <div className='asset'>
            <img src='/assets/welcome/arrow.svg' alt='회원가입하기'></img>
          </div>
        </div>
      </div>
    </div>
